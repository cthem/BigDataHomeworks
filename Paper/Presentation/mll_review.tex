...
\item[$\star$] Precision, Recall,  F$^\beta$ -measure
\end{itemize}
...
\item[$\bullet$] Split $x$ at the $l$-th feature\footnote{$x$ has to contain distinct features} s.t. the information gain criterion is maximized
...
\item[$\bullet$] Consider signed distance of $x_i$ from the boundary of every
  relevant-nonrelevant label pair $(y_j,y_k) \in Y_i \times \bar Y_i$. The
  pair's decision hyperplane is: $h_j, h_k$: $\left<w_j-w_k, x_i \right> + b_j - b_k=0$
