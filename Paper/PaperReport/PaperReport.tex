...
\begin{document}
	...
	\begin{itemize}
		...
		\begin{itemize}
			\item \textbf{Classification: }Let $B(TP_j, FP_j, TN_J, FN_J)$ represent some specific binary classification metric $(B \in \{Accuracy, Precision, Recall, F^ \beta \})$. The metrics from classification perspective are the following:
			\begin{itemize}
